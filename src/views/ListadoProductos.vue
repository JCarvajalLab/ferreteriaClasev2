...
<div class="general">
    ...
    <nav class="nav" style="background-color: darkseagreen; padding: 15px">
        <a href="/"><img class="imagelogo" :src="require('@/assets/logo_ferreteria.jpg')" alt="Logo" />
        </a>
...
<div class="container">
    ...
    <div class="product-grid" v-for="(productos, index) in producto" :key="index">
        <router-link :to="`/detalleproducto/${productos.id}`" class="product-card-link">
